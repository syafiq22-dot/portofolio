...
console.log('%cWelcome to my portfolio!', 'color: #8b5cf6; font-size: 14px;');
console.log('%cInterested in the code? Feel free to reach out!', 'color: #6b7280; font-size: 12px;');